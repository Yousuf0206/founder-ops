    ...
    <form action={formAction} className="mt-6 flex flex-col gap-6">
      <section>
        ...
        <textarea
          ...
          className="mt-2 w-full rounded-md border border-[--color-line] bg-[--color-surface] px-3 py-2 font-mono text-sm"
        />
      </section>
      ...
      <section>
        ...
        <textarea
          ...
          className="mt-2 w-full rounded-md border border-[--color-line] bg-[--color-surface] px-3 py-2 text-sm"
        />
      </section>
